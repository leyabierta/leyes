...
referencias_posteriores:
  ...
  - norma: BOE-A-2026-17906
    relacion: SE AMPLÍA
    texto: lo indicado de la Instrucción IF-02, apéndice 1, tabla A, por Resolución de 5 de agosto de 2026
---
...
Incluye corrección de erratas publicada en BOE núm. 257, de 25 de octubre de 2019.
...
| a) m2 = 26 m3 x LII. b) m3 = 130 m3 x LII. c) Para aire exterior aplicar límite de toxicidad por volumen del local punto 3.3.2 de IF-04 y para salas de máquinas IF-07. |  |  |  |  |  |
...
| a) m2 = 26 m3 x LII. b) m3 = 130 m3 x LII. c) Para aire exterior aplicar límite de toxicidad por volumen del local punto 3.3.2 de IF-04 y para salas de máquinas IF-0. |  |  |  |  |  |
...
| a Para soldaduras y dimensiones de las uniones donde los ultrasonidos (UT) o radiografías (RT) no permitan una clara evaluación, se efectuará una comprobación con líquidos penetrantes (PT). b Hasta DN ≤600, se controlará al 100% el 10% de las soldaduras, para DN >600 se controlará el 10% de la longitud total de las soldaduras. END = Ensayos No Destructivos. |  |
