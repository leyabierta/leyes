...
C31 m = Co m + 1 = Vo m + 1, es decir, que la concentración ponderada al final del período m coincide con el valor inicial del período siguiente, m + 1.
