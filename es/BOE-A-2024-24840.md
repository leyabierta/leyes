...
| A) Total ingresos de gestión ordinaria. | 0 | -12.9 | -19.8 |
| 5. Otros gastos de gestión ordinaria. | 0 | - 12.900 | - 19.800 |
| a) Suministros y servicios exteriores. | 0 | 0 |  |
| b) Otros. | 0 | - 12.900 | - 19.800 |
| B) Total de gastos de gestión ordinaria (4+5). | 0 | -12.9 | -19.8 |
| I. Resultado (ahorro o desahorro) de la gestión ordinaria (A+B). | 0 | -25.8 | -19.8 |
