...
Para obtener las semielasticidades de los ingresos y gastos respecto a la brecha de producción, se les resta a las elasticidades ηRy ηGla unidad y se multiplican por las ratios de ingresos-PIB![1](/datos/imagenes/disp/2016/238/08967_5209.png)y de gastos-PIB![3](/datos/imagenes/disp/2016/238/08967_5352.png), respectivamente, puesto que las variables fiscales suelen expresarse en porcentaje del PIB.
...
| --- | --- | --- | --- | --- | --- | --- |
| Elasticidades ingresos  y gastos | Pesos (%) (1) | (A) x (B)/100 | Semielasticidades respecto del PIB de ingresos/PIB  y gastos/PIB  (C) - 1 | Pesos de  ingresos y  gastos totales  (% PIB) (1) | Semielasticidades  de ingresos,  gastos y saldo  (D) x (E)/100 |  |
