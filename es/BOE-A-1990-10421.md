...
d) Las muestras mínimas son:

|  | Número de unidades muestrales | Marco-Posición | Suplemento por exceso |
| --- | --- | --- | --- |
| Siniestros con daños no uniformes. | 8 Ud/parcela. | 1 X 8 | 4 Ud/Ha. |
| Siniestros con daños uniformes. | 4 Ud/parcela. | 1 x 4 | 2 Ud/Ha. |

Marco-Posición: El primer número indica el número de unidades muestrales a tomar en cada posición. El segundo indica el número de posiciones a realizar en la parcela.
...
Tanto para la cuantificación de los daños como para la estimación de las producciones pertinentes, se procederá al estudio pormenorizado del total de las hojas y partes vegetativas de las plantas elegidas como muestras.

En las determinaciones realizadas en los muestreos, no se contabilizarán a efectos de estas producciones, ni por lo tanto, como pérdidas, toda aquella producción destruida o depreciada por siniestros no garantizados.
...
| Porcentaje de superficie afectada | Porcentaje de daños |
| --- | --- |
| 0-10 | 0-10 |
| 11-20 | 11-30 |
| 21-40 | 31-60 |
...
| Número de desgarros | Porcentaje de daños |
| --- | --- |
| 1-3 | 5-10 |
...
Para las plantas de menos de 20 hojas, los porcentajes del peso de cada piso serán incrementados, proporcionalmente a sus pesos, la parte que le corresponde de la reducción que se haga del 4.º y 5.º piso, de tal modo que la suma total del porcentaje sea 100.
