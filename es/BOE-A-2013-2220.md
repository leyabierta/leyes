...
referencias_anteriores:
  - norma: BOE-A-1995-1858
    relacion: CITA
    texto: Orden de 20 de enero de 1995
  - norma: BOE-A-2003-21539
    relacion: DE CONFORMIDAD con
    texto: art. 18 de la Ley 46/2003, de 25 de noviembre
  - norma: BOE-A-2004-5118
    relacion: DE CONFORMIDAD con
    texto: art. 5.5.f) del Real Decreto 433/2004, de 12 de marzo
referencias_posteriores:
  - norma: BOE-A-2013-4932
    relacion: SE MODIFICA
    texto: el art. 5, por Resolución de 24 de abril de 2013
  - norma: BOE-A-2014-13398
    relacion: SE MODIFICA
    texto: el art. 2, por Resolución  de 27 de noviembre de 2014
  - norma: BOE-A-2017-15509
    relacion: SE DEROGA
    texto: ", por Resolución de 14 de diciembre de 2017"
---
...
2. Los precios contenidos en el anexo II, serán abonados por todas las instituciones solicitantes, públicas o privadas, con excepción de aquellas con las que el Museo Nacional del Prado pueda establecer un acuerdo de intercambio de préstamos o servicios.
...
4. Los precios reflejados en el anexo II reflejan exclusivamente los gastos por gestión de préstamos y no incorporan cualquier otro gasto derivado de la preparación técnica de las obras, seguros, transporte, correos, etc., cuyo contenido se especifica en el documento a firmar por el prestatario denominado «Acuerdo de Condiciones de Préstamo».

5. Si como condición para su préstamo, la obra u obras solicitadas necesitaran de una intervención en los talleres de Restauración del Museo, el Departamento de Restauración será el encargado de realizar un presupuesto en función del tiempo estimado de trabajo (número de horas) de la intervención de la obra. El envío del presupuesto al prestatario y su conformidad permitirá continuar la gestión del préstamo.

6. El precio de la restauración será sufragado por las instituciones solicitantes, públicas o privadas, salvo cuando la Dirección del Museo exima de su pago en atención a los compromisos reflejados en los acuerdos o convenios que se hayan suscrito.
...
Precios de servicios y actividades de divulgación cultural del Museo Nacional del Prado
...
Precios por préstamos de obras de arte del Museo Nacional del Prado
...
Precios de la Biblioteca del Museo Nacional del Prado
...
Precios por visitas formativas de grupos profesionales y de másteres universitarios a salas de reserva y departamento de restauración
