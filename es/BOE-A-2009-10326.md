...
| IMPORTE TOTAL DECLARACIÓN 1 . | 13 posiciones numéricas (11 enteros y 2 decimales). |
| OPCIÓN FRACCIONAMIENTO 1 . | 1 posición numérica (1=no fracciona, 2=fracciona y no domicilia, 3= fracciona y domicilia 2.º plazo). |
...
| 1Campos que únicamente tienen contenido cuando el modelo sea el 100 (Impuesto sobre la Renta de las Personas Físicas. Declaración anual o borrador de declaración). |  |
...
![imagen](/datos/imagenes/disp/2023/95/9704_13093364_1.png)
