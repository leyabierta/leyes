...
| Parámetros | Incertidumbre de medida  (véase la nota 1)  % del valor paramétrico  (excepto para el pH) | Notas |
| --- | --- | --- |
| Aluminio. | 25 |  |
| Amonio. | 40 |  |
| Antimonio. | 40 |  |
...
| Parámetros | Exactitud  (véase la nota 2)  % del valor paramétrico (excepto para el pH) | Precisión  (véase la nota 3)  % del valor paramétrico (excepto para el pH) | Límite de detección  (véase la nota 4)  % del valor paramétrico (excepto para el pH) | Notas |
| --- | --- | --- | --- | --- |
| Aluminio. | 10 | 10 | 10 |  |
| Amonio. | 10 | 10 | 10 |  |
| Antimonio. | 25 | 25 | 25 |  |
