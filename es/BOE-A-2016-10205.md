...
## ANEXO. Valores medios regionales definitivos y número máximo de derechos de pago básico, establecidos por asignación inicial, que caracterizan a cada una de las regiones del modelo de aplicación regional para el régimen de pago básico
