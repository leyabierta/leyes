...
| Superficie indemnizable en las explotaciones | C1Coeficiente aplicable al módulo base |
| --- | --- |
...
| Base imponible general declarada por el beneficiario | C2Coeficiente aplicable al módulo base |
| --- | --- |
