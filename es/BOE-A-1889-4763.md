...
2aEl testador comparecerá con el testamento cerrado y sellado, o lo cerrará y sellará en el acto, ante el Notario que haya de autorizarlo.
...
5aExtendida y leída el acta, la firmará el testador que pueda hacerlo y, en su caso, las personas que deban concurrir, y la autorizará el Notario con su signo y firma.
...
6aTambién se expresará en el acta esta circunstancia, además del lugar, hora, día, mes y año del otorgamiento.

7aConcurrirán al acto de otorgamiento dos testigos idóneos, si así lo solicitan el testador o el Notario.
