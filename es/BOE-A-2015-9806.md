...
|  | Fósforo total  (media anual) | Clorofila a  (media anual) | Clorofila a  (máximo anual) | Transparencia del disco de Secchi*  (media anual) |
| --- | --- | --- | --- | --- |
| EUTROFIA. | mg P/m 3 | mg chl a /m 3 | mg chl a /m 3 | m |
| > 35 | > 8 | > 25 | < 2,0 |  |
...
| --- | --- | --- | --- |
| EUTROFIA. | Nutrientes. | Amonio.  Nitratos.  Nitritos.  Fosfatos.  Nitrógeno total**.  Fósforo total**. | >Límite de estado bueno/moderado. |
| Fitoplancton. | Chl-a. | >Límite de estado bueno/moderado. |  |
| * Los indicadores de eutrofia en cuanto a nutrientes serán los especificados para cada categoría y tipo.  ** Se usarán en caso de que no hayan sido definidos los límites de estado bueno/moderado para amonio, nitratos, nitritos ni fosfatos. |  |  |  |
