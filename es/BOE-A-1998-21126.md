...
referencias_anteriores:
  ...
  - norma: BOE-A-1993-31153
    ...
    texto: el art. 13 de la Ley 22/1993, de 29 de diciembre
  - norma: BOE-A-1994-9263
    relacion: DEROGA
    texto: Real Decreto 647/1994, de 15 de abril
  - norma: BOE-A-1995-3680
    relacion: DEROGA
    texto: Real Decreto 106/1995, de 27 de enero
  - norma: BOE-A-1997-14057
    relacion: DEROGA
    texto: Real Decreto 901/1997, de 16 de junio
referencias_posteriores:
  - norma: BOE-A-1998-24261
    relacion: CORRECCIÓN de errores
    texto: en BOE núm. 252, de 21 de octubre de 1998
  - norma: BOE-A-1999-12488
    relacion: SE MODIFICA
    texto: el art. 6, tarifas 1 y 3, por Real Decreto 845/1999 de 21 de mayo
  ...
  - norma: BOE-A-2014-9895
    relacion: SE DEROGA
    texto: ", por Ley 16/2014, de 30 de septiembre"
---
...
Incluye la corrección de errores publicada en BOE núm. 252, de 21 de octubre de 1998.Ref. BOE-A-1998-24261.
...
No será exigible la cuota fija mínima de 150.000 pesetas a aquellas emisiones de valores de la misma naturaleza que un mismo emisor realice en el marco de un programa, siempre que el número de emisiones previsto en el programa sea superior a 10. En este caso, la cuota a aplicar a cada emisión será el resultado de multiplicar la base por el tipo establecido en el párrafo anterior.

Tarifa 3. Suplemento o modificaciones de folletos de emisión registrados que no afectan al valor nominal de la emisión o emisiones excepto folletos incompletos: cuota fija 22.900 pesetas.
...
El tipo de gravamen será el 0,5 por 1.000. Si el capital social o el patrimonio superan la cifra de 1.500.000.000 de pesetas, se aplicará esta última cifra como base imponible.
...
El tipo de gravamen será el 0,125 por 1.000. Cuando la cuota que resulte de aplicar el anterior tipo de gravamen fuera inferior a 25.000 pesetas, se aplicará una cuota fija de 25.000 pesetas.
...
| Importe de la operación  –  Pesetas | Tipos  –  Pesetas |
| --- | --- |
| Hasta 5.000 | 0 |
...
Cuando la cuota que resulte de aplicar los anteriores tipos de gravamen fuera inferior a 2.500 pesetas, se aplicará una cuota fija de 2.500 pesetas.
...
2. Contratos derivados de renta variable (acciones e índices) de valor nominal inferior e igual a 1.000.000 de pesetas: 0,27 pesetas por cada contrato negociado en el trimestre natural.
...
Cuando la cuota que resulte de aplicar el anterior tipo de gravamen fuera inferior a 2.500 pesetas, se aplicará una cuota fija de 2.500 pesetas.
...
a) Una cuota fija de 2.000 pesetas.

b) Una cuota resultante de aplicar a la base imponible, constituida por el número de páginas superior a seis de que conste el certificado de que se trate, el tipo de gravamen de 10 pesetas por página.
