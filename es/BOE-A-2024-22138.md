...
fuente: https://www.boe.es/eli/es/o/2024/10/17/hac1177
articulos: 24
reformas:
  - fecha: "2024-10-28"
    fuente: BOE-A-2024-22138
materias:
...
referencias_anteriores:
  - norma: BOE-A-2003-23186
    ...
    texto: el art. 29.2.j) de la Ley 58/2003, de 17 de diciembre
  - norma: BOE-A-2023-24840
    relacion: DE CONFORMIDAD con
    texto: el Real Decreto 1007/2023, de 5 de diciembre
referencias_posteriores:
  - norma: BOE-A-2024-23180
    relacion: CORRECCIÓN de errores
    texto: en BOE núm. 270, de 8 de noviembre de 2024
---
...
Especificaciones técnicas y funcionales de las características y requisitos de los sistemas informáticos de facturación
...
![imagen](/datos/imagenes/disp/2024/260/22138_14945626_1.png)
...
![imagen](/datos/imagenes/disp/2024/260/22138_14945627_1.png)

2.3 Bloque 3: «RegistroAlta».

Bloque correspondiente a los datos de un registro de facturación de alta.

![imagen](/datos/imagenes/disp/2024/260/22138_14945628_1.png)

![imagen](/datos/imagenes/disp/2024/260/22138_14945628_2.png)

![imagen](/datos/imagenes/disp/2024/260/22138_14945628_3.png)

![imagen](/datos/imagenes/disp/2024/270/22138_14945628_4.png)

![imagen](/datos/imagenes/disp/2024/260/22138_14945628_5.png)

![imagen](/datos/imagenes/disp/2024/260/22138_14945628_6.png)

2.4 Bloque 4: «RegistroAnulacion».

Bloque correspondiente a los datos de un registro de facturación de anulación.

![imagen](/datos/imagenes/disp/2024/260/22138_14945629_1.png)

![imagen](/datos/imagenes/disp/2024/260/22138_14945629_2.png)

![imagen](/datos/imagenes/disp/2024/260/22138_14945629_3.png)

![imagen](/datos/imagenes/disp/2024/260/22138_14945629_4.png)

2.5 Bloque 5: «RegistroEvento».

Bloque correspondiente a los datos de un registro de evento.

![imagen](/datos/imagenes/disp/2024/260/22138_14945630_1.png)

![imagen](/datos/imagenes/disp/2024/270/22138_14945630_2.png)

![imagen](/datos/imagenes/disp/2024/260/22138_14945630_3.png)

![imagen](/datos/imagenes/disp/2024/260/22138_14945630_4.png)

![imagen](/datos/imagenes/disp/2024/270/22138_14945630_5.png)

![imagen](/datos/imagenes/disp/2024/270/22138_14945630_6.png)

![imagen](/datos/imagenes/disp/2024/260/22138_14945630_7.png)

![imagen](/datos/imagenes/disp/2024/260/22138_14945630_8.png)

![imagen](/datos/imagenes/disp/2024/260/22138_14945630_9.png)
...
![imagen](/datos/imagenes/disp/2024/260/22138_14945631_1.png)

![imagen](/datos/imagenes/disp/2024/260/22138_14945631_2.png)
...
| 2 | Impuesto sobre la Producción, los Servicios y la Importación (IPSI) de Ceuta y Melilla. |
...
| 9 | Facturación de las prestaciones de servicios de agencias de viaje que actúan como mediadoras en nombre y por cuenta ajena (D.A.4.ª RD1619/2012) |
...
| Valores | Descripción |
| --- | --- |
| 1 | Versión actual (1.0) del esquema utilizado. |
...
| 2 | Integridad-firma. |
| 3 | Integridad - Otros. |
| 4 | Trazabilidad-cadena-registro - Reg. no primero pero con reg. anterior no anotado o inexistente. |
| 5 | Trazabilidad-cadena-registro - Reg. no último pero con reg. posterior no anotado o inexistente. |
| 6 | Trazabilidad-cadena-registro - Otros. |
| 7 | Trazabilidad-cadena-huella - Huella del reg. no se corresponde con la 'huella del reg. anterior' almacenada en el registro posterior. |
| 8 | Trazabilidad-cadena-huella - Campo 'huella del reg. anterior' no se corresponde con la huella del reg. anterior. |
| 9 | Trazabilidad-cadena-huella - Otros. |
...
| Valores | Descripción |
| --- | --- |
| 1 | Inicio del funcionamiento del sistema informático como «NO VERI*FACTU». |
| 2 | Fin del funcionamiento del sistema informático como «NO VERI*FACTU». |
| 3 | Lanzamiento del proceso de detección de anomalías en los registros de facturación. |
| 4 | Detección de anomalías en la integridad, inalterabilidad y trazabilidad de registros de facturación. |
| 5 | Lanzamiento del proceso de detección de anomalías en los registros de evento. |
| 6 | Detección de anomalías en la integridad, inalterabilidad y trazabilidad de registros de evento. |
| 7 | Restauración de copia de seguridad, cuando ésta se gestione desde el propio sistema informático de facturación. |
| 8 | Exportación de registros de facturación generados en un periodo. |
| 9 | Exportación de registros de evento generados en un periodo. |
