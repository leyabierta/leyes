...
| Por cada asignatura de grado superior | 9.75 |
...
| Diploma elemental | 2.09 |
| Diploma de instrumentista o cantante | 3.76 |
...
| Renta familiar | Número de hijos |  |  |  |
| --- | --- | --- | --- | --- |
| 1  -  Porcentaje | 2  -  Porcentaje | 3  -  Porcentaje | 4 y más  -  Porcentaje |  |
...
| a) Espectáculos públicos y actividades recreativas (cines, teatros, campos de deporte, discotecas y similares) | 7.75 |
...
| Hoteles y hoteles-apartamentos de una estrella | 7.75 |
...
| b) Consultas, clínicas y centros similares de asistencia en régimen ambulatorio (sin hospitalización) | 7.75 |
...
| Botiquines y depósitos de medicamentos. | 1.55 |
| Servicios de farmacia | 7.75 |
...
| Expedición de informes a petición de parte. | 7.75 |
| Expedición de informes sanitarios para legalizar aguas de consumo | 21.2 |
...
| Densidad mínima de una arena | 2.12 |
...
| Ídem en muestras remoldeadas | 26.5 |
...
| Ídem de muestra remoldeada | 26.5 |
...
| Corte directo de suelos en aparato Casagrande, muestra inalterada, ensayo rápido | 8.48 |
...
| Materia orgánica con dicromato | 3.71 |
...
| Testigo de 100 milímetros de diámetro | 23.85 |
| Por cada testigo de más en el mismo desplazamiento | 7.95 |
| Testigo de 150 milímetros de diámetro | 29.68 |
| Por cada testigo de más en el mismo desplazamiento | 9.54 |
| 4. Áridos: |  |
...
| Friabilidad de los áridos | 9.01 |
...
| Adhesividad de los áridos mediante la placa Vialit | 11.13 |
| 5. Conglomerantes: |  |
| a) Cemento: |  |
...
| Peso específico de los aditivos líquidos | 3.18 |
...
| Fabricación, conservación y rotura a flexotracción de probetas prismáticas de 15 × 15 × 60 centímetros (seis o menos) | 20.14 |
...
| Refrentado de una probeta con mortero | 2.65 |
...
| Por cada probeta testigo más en el mismo desplazamiento | 5.83 |
| Testigo de 100 milímetros de diámetro | 20.723 |
| Por cada probeta testigo más en el mismo desplazamiento | 6.89 |
| Testigo de 150 milímetros de diámetro | 25.44 |
...
| Rotura a compresión simple de una probeta cilíndrica de 10 o más centímetros de diámetro de un material estabilizado | 1.59 |
| Rotura a compresión simple de una probeta cilíndrica de un diámetro inferior a 10 centímetros de un material estabilizado | 1.59 |
...
| Ensayo de compactación de una mezcla de grava-cemento | 6.36 |
...
| Ensayo de compactación con martillo vibrante de una mezcla de grava-escoria o escoria-escoria | 7.95 |
...
| Ensayo de inmersión-compresión en mezclas de grava-emulsión (seis probetas) | 21.2 |
...
| Punto de reblandecimiento anillo y bola | 4.77 |
...
| Temperatura de equiviscosidad | 14.31 |
| Destilación | 14.31 |
| Fenoles | 4.505 |
| Naftalinas | 4.505 |
...
| Fabricación de probetas inmersión-compresión (tres probetas) | 9.01 |
...
| Contenido en árido silíceo | 4.24 |
| Equivalente centrífugo de keroseno | 10.6 |
...
| Coeficiente de resistencia al deslizamiento con el péndulo TRRL (nueve medidas por punto kilométrico) | 21.73 |
...
| d) Esferas de vidrio: |  |
| Determinación de porcentaje de esferas de vidrio defectuosas | 10.07 |
| Análisis granulométrico | 4.399 |
| Resistencia al agua | 4.611 |
| Resistencia a los ácidos | 4.77 |
| Resistencia a la solución de cloruro cálcico . | 4.77 |
...
| Resistencia a la inmersión en agua | 3.71 |
| 11. Aceros: |  |
...
| Vehículo o máquina empleado como elemento de reacción para la realización de ensayo por hora de trabajo | 3.71 |
...
a) Buceo profesional 2.aclase restringido: 3.000 pesetas.
