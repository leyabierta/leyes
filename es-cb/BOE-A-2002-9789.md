...
Componente fijo: 3,61 euros/abonado y año.

Componente variable:

Régimen general: 0,18 euros/metro cúbico consumido o estimado.

Régimen de medición directa de la carga contaminante:

0,19 euros por kilogramo: Materias en Suspensión (MES).

0,22 euros por kilogramo: Demanda Química de Oxígeno (DQO).

0,48 euros por kilogramo: Fósforo (P).

3,77 euros por kiloequitox: Materias Inhibitorias (MI).

3,01 euros por Siemens/cm: Sales solubles (SOL).

0,24 euros por kilogramo: Nitrógeno total (N).

0,00004 euros por ºC: Incremento de Temperatura (IT) superior a 3º C.
