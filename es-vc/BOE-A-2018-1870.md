...
| 2.1 | Relación de absorción de sodio ajustada (ASAR). | 2,39 |
...
| 4.9 | Hierro. | 13,28 |
| 4.1 | Estabilidad de una emulsión. | 7,26 |
...
| 5.1 | Otras (con un máximo de 22,00 euros). | Según coste |
...
| 6.1 | Anhídrido sulfuroso total o libre (cada una). | 4,53 |
...
| 6.29 | Etanal. | 10,73 |
| 6.3 | Materiales colorantes artificiales. | 15,31 |
...
| 11.1 | Otras (con un máximo de 88,02 euros). | Según coste |
...
| 13.1 | Otras (con un máximo de 88,02 euros). | Según coste |
...
| 18.1 | Composición de la fracción de ácidos grasos por cromatografía de gases. | 7,35 |
...
| 22.2 | Otras (con un máximo de 88,02 euros). | Según coste |
...
| 23.8 | pH. | 7,35 |
| 23.9 | Cloruros. | 7,04 |
| 23.1 | Ácido cítrico, láctico, málico, tartárico, benzoico, sórbico o salicílico (cada una). | 22,06 |
...
| 24.1 | Anhídrido sulfuroso total. | 3,06 |
...
| 4.1 | Expedición de duplicados de documentos oficiales. | 10,50 euros, cada uno. |
...
| TS0006 | Servicio de asistencia sanitaria por helicóptero medicalizado | 8.2 |
